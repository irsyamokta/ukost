<!-- Kost Items -->
<div
    class="group h-auto max-w-[300px] flex-shrink-0 overflow-hidden rounded-lg bg-[#3A3734] text-white shadow-md hover:bg-[#302E2C]">
    <a href="product.html" class="group relative block overflow-hidden">
        <!-- Gambar -->
