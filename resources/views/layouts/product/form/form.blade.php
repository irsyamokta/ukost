<section class="hidden w-2/5 md:block">
    <form class="sticky top-24 rounded-lg bg-gray-50 p-4 shadow-md">
        <!-- Harga -->
        <div class="py-2">
            <span class="font-semibold">Rp.
                <span class="text-xl"> 1.800.000 </span>
            </span>
            <span> /Bulan </span>
        </div>
        <!-- Administrasi -->
        <div class="flex gap-2 py-2">
            ...
            <!-- Time -->
            <select id="countries"
                class="block w-1/2 rounded-lg border border-gray-300 bg-gray-50 p-2.5 text-sm text-gray-900 focus:border-bluePrimary focus:ring-bluePrimary">
        ...
        <!-- Rincian -->
        <div class="mb-1 flex flex-wrap items-center justify-between gap-2 rounded-lg border p-4 text-sm font-semibold">
