<div class="py-7 text-black">
    <div class="mb-5">
        <h1 class="text-start text-xl font-semibold">
            Tipe Kamar Lainnya
        </h1>
        <span class="text-sm">Kos Margin Syariah</span>
    </div>
    <div id="other-type" class="flex items-center gap-4 overflow-x-scroll py-1">
        <div
            class="group h-auto max-w-[300px] flex-shrink-0 overflow-hidden rounded-lg bg-white shadow-md hover:bg-gray-100">
            <a href="" class="group relative block overflow-hidden">
                <!-- Gambar -->
                <div class="h-44 w-[300px] overflow-hidden">
                    <img loading="lazy" src="/assets/product-2.png"
                ...
                <div class="p-2">
                    ...
                    <div class="mb-1 flex justify-between text-[10px]">
                        ...
                        <span
                            class="rounded-md border border-blue-500 px-2 py-1 text-xs font-medium text-blue-500">Pria</span>
                    </div>
                    <!-- Nama Kost & Lokasi -->
                    <div class="mb-4">
                        <h5 class="text-base font-medium">Kos Sinar Harapan</h5>
                        <span class="flex items-center gap-1">
                            <svg class="h-5 w-5 text-gray-500" width="20" height="20" viewBox="0 0 20 20"
